...
public class DaftarVideoAdapter extends RecyclerView.Adapter<
        DaftarVideoAdapter.ItemVideoViewHolder> {
    ...
    public class ItemVideoViewHolder extends RecyclerView.ViewHolder implements
        ...
        public void onClick(View view) {
            ...
            Intent detilIntent = new Intent(mContext, DetilVideoActivity2.class);
            Bundle bundle = new Bundle();
            bundle.putSerializable("DetilVideo",mDaftarVideo);
