...
public class AsyncTaskLoader2 extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Void> {
    ...
    static class ContohLoader extends AsyncTaskLoader<Void> {
        static WeakReference<AsyncTaskLoader2> mActivity;
        int mCounter = 0;

        public ContohLoader(@NonNull Context context, int n, AsyncTaskLoader2 main){
            super(context);
            mCounter = n;
            mActivity = new WeakReference<AsyncTaskLoader2>(main);
        }
